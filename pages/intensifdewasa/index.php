                                        ...
                                        <div class="bedstat <?php
                                            ...
                                            <div class="bedstat-header">
                                                <div class="bedtitle">
                                                    ...
                                                    echo($row['namabed'].' | <small><small>'.$row['kelas'].'</small></small>');
                                                    ?></b>
                                                </div>
                                                <div class="bedstatus">
                                                    <b><?php
                                                    ...
                                                    if($row['bedstatus']==0){
                                                        echo('<small>Ready To Use</small>');
                                                    }else if($row['bedstatus']==1){
                                                        echo('<small>Rencana Pulang</small>');
                                                    }else if($row['bedstatus']==2){
                                                        echo('<small>Ready To Clean</small>');
                                                    }else if($row['bedstatus']==3){
                                                        echo('<small>Renovasi</small>');
                                                    }else if($row['bedstatus']==6){
                                                        echo('<small>Booking</small>');
                                                    }else if($row['bedstatus']==5){
                                                        echo('<small>Terisi</small>');
                                                    }else if($row['bedstatus']==7){
                                                        echo('</small>Terisi</small>');
                                                    }else if($row['bedstatus']==8){
                                                        echo('</small>Terisi</small>');

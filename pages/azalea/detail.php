                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="row">
                                    ...
                                    ?>
                                            <a class="btn btn-warning btn-sm btn-block" href="../controller/backtoterisi.php?id=<?php echo($id)?>&trx_id=<?php echo($trx_id)?>&status=batalrencanapulang" role="button"><i class="fa fa-bed"> </i> BATAL RENCANA PULANG</a>
